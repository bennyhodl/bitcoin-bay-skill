...
if (!command || command === "help" || command === "--help") {
  ...
  console.log("Usage: bitcoin-bay-website <command> [flags]\n");
  console.log("Commands:");
  for (const [name, cmd] of Object.entries(commands)) {
    console.log(`  ${name.padEnd(20)} ${cmd.desc}`);
  }
  console.log(`\nRun 'bitcoin-bay-website <command> --help' for flag details.`);
...
if (!cmd) {
  ...
  console.error(`Run 'bitcoin-bay-website help' for available commands.`);
  process.exit(1);
}
...
if (flags.help) {
  ...
  console.log(`Usage: bitcoin-bay-website ${command} ${cmd.usage}`);
  process.exit(0);
}
